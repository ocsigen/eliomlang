...
[@@@ocaml.warning "-3"]
(* OASIS_START *)
(* DO NOT EDIT (digest: 286ce62125732d1e01e7818d59265ef5) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["El_desugar"; "El_server"; "El_client"];
                      lib_pack = false;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "desugar.ml"});
               Executable
                 ({
                     cs_name = "server";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "jk\216\207\150\169\233\028f\203\153x?\189\254\200";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
