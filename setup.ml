...
[@@@ocaml.warning "-3"]
(* OASIS_START *)
(* DO NOT EDIT (digest: a7a2c945e3242a634b124327bcd1eb1d) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "eliom_typechecker";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some ":\242\190d0g\185\206c\212\220-\224m3\007";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
