...
[@@@ocaml.warning "-3"]
(* OASIS_START *)
(* DO NOT EDIT (digest: 02d6ff9b8e9e73cbf775888ca543a32c) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("eliom_typechecker", None);
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\215>\135Z\224\014\247\237\004'D\221\192c\162\197";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
