...
[@@@ocaml.warning "-3"]
(* OASIS_START *)
(* DO NOT EDIT (digest: 2725bd6f4d36dab14ef0be6f16830902) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "eliom_lang";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "eliom_lang"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "eliom_lang";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = Some "runtime";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "n]\192\"!\198\183~\211\235o9@x\179\189";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
