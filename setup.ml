...
(* OASIS_START *)
(* DO NOT EDIT (digest: ad52f88e4808f6a4736fd238cf536403) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Eliom_lang"; "El_desugar"; "El_client"];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("compiler-libs.optcomp", None);
                           InternalLibrary "eliom_lang"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                   ...
                   {exec_custom = false; exec_main_is = "optmain.ml"});
               SrcRepo
                 ({
                     cs_name = "head";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\205&v\205\193d\182\205K\022\253\022\219\197\136\186";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
