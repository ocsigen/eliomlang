...
[@@@ocaml.warning "-3"]
(* OASIS_START *)
(* DO NOT EDIT (digest: 516ff0ce3687548e5eadedcb547493f9) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Eliom_lang"; "El_desugar"; "El_server"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\241\203\176j\210I\"5x\216\225`\011\018\007\239";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
