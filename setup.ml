...
[@@@ocaml.warning "-3"]
(* OASIS_START *)
(* DO NOT EDIT (digest: cf9f47bb427b18bbf07f26533629e34a) *)
(*
...
let setup_t =
  {
                   ...
                   [
                      (OASISExpr.EBool true,
                        ("$ppx_tester",
                          [
                             "test/shared.eliom";
                             "test/shared.result.eliom";
                             "test/shared.expected.eliom"
                          ]))
                   ];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["El_desugar"];
                      lib_pack = false;
                      lib_internal_modules = ["El_utils"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "internal";
                      lib_findlib_directory = None;
                      lib_findlib_containers = ["eliomlang"; "ppx"]
                   });
               Executable
                 ({
                     cs_name = "eliom_desugar";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "bin";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "eliomlang_ppx"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "eliom_desugar.ml"});
               Library
                 ({
                     cs_name = "eliomlang_ppx_ex";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      lib_modules = [];
                      lib_pack = false;
                      lib_internal_modules = ["Eliom_desugar_ex"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "ppx";
                      lib_findlib_directory = None;
                      lib_findlib_containers = ["eliomlang"]
                   });
               Library
                 ({
                     cs_name = "eliom_runtime_server";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules =
                        ["Eliom_runtime"; "Eliom_wrap"; "Eliom_fragment"];
                      lib_pack = false;
                      lib_internal_modules = ["Eliom_serial"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "server";
                      lib_findlib_directory = Some "server";
                      lib_findlib_containers = ["eliomlang"; "runtime"]
                   });
               Library
                 ({
                     cs_name = "eliom_runtime_client";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("js_of_ocaml.log", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   },
                   {
                      ...
                      lib_findlib_directory = Some "client";
                      lib_findlib_containers = ["eliomlang"; "runtime"]
                   });
               Library
                 ({
                     cs_name = "eliom_runtime_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "eliom_runtime_server";
                           FindlibPackage ("lwt", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   {
                      lib_modules = ["Eliom_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "lwt";
                      lib_findlib_directory = Some "lwt";
                      lib_findlib_containers = ["eliomlang"; "runtime"]
                   });
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/Drup/eliom-lang.git";
                      src_repo_browser =
                        Some "https://github.com/Drup/eliom-lang";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_tester.ml"});
               Test
                 ({
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\255\247\181\t\129\138\140j\216\1944*\023\203\000L";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
