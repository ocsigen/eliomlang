...
[@@@ocaml.warning "-3"]
(* OASIS_START *)
(* DO NOT EDIT (digest: c597ece200179b120aac2ec07ad3142c) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "eliom_lang_ppx"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "eliom_ppx.ml"});
               Executable
                 ({
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_containers = ["eliom_lang"; "runtime"]
                   });
               Library
                 ({
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\0254\170\203\252\200\234w`r\225\251_\171#\204";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
