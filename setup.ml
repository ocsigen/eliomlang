...
[@@@ocaml.warning "-3"]
(* OASIS_START *)
(* DO NOT EDIT (digest: 1ad982298993e07f90cf9bb6ee231305) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Eliom_lang"; "El_desugar"; "El_server"; "El_client"
                        ];
                      lib_pack = false;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "y\251\014\202QJ\218\170:\250F\238[\129\183.";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
