...
(* OASIS_START *)
(* DO NOT EDIT (digest: 15babd765300b22577a8cbea52ec91f6) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Eliom_lang"];
                      lib_pack = false;
                      lib_internal_modules = ["El_utils"; "El_desugar"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "&\180\029?\232\160\015\186E\209\026\177/m\r\184";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
